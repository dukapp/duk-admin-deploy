...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1373: Date.now,
      _1375: s => new Date(s * 1000).getTimezoneOffset() * 60,
      _1376: s => {
      ...
      _1378: () => typeof dartUseDateNowForTicks !== "undefined",
      _1379: () => 1000 * performance.now(),
      _1380: () => Date.now(),
      _1381: () => {
      ...
      _1383: () => new WeakMap(),
      _1384: (map, o) => map.get(o),
      _1385: (map, o, v) => map.set(o, v),
      _1386: x0 => new WeakRef(x0),
      _1387: x0 => x0.deref(),
      _1394: () => globalThis.WeakRef,
      ...
      _1410: Object.is,
      _1411: o => o instanceof Array,
      _1412: (a, i) => a.push(i),
      _1416: a => a.pop(),
      _1417: (a, i) => a.splice(i, 1),
      _1418: (a, s) => a.join(s),
      _1419: (a, s, e) => a.slice(s, e),
      _1421: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1422: a => a.length,
      _1424: (a, i) => a[i],
      _1425: (a, i, v) => a[i] = v,
      _1427: o => {
      ...
      _1428: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1430: o => o instanceof Uint8Array,
      _1431: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1432: o => o instanceof Int8Array,
      _1433: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1434: o => o instanceof Uint8ClampedArray,
      _1435: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1436: o => o instanceof Uint16Array,
      _1437: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1438: o => o instanceof Int16Array,
      _1439: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1440: o => o instanceof Uint32Array,
      _1441: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1442: o => o instanceof Int32Array,
      _1443: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1445: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1446: o => o instanceof Float32Array,
      _1447: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1448: o => o instanceof Float64Array,
      ...
      _1492: (handle) => clearTimeout(handle),
      _1493: (ms, c) =>
      setInterval(() => dartInstance.exports.$invokeCallback(c), ms),
      _1494: (handle) => clearInterval(handle),
      _1495: (c) =>
      ...
      _1498: (x0,x1) => x0.exec(x1),
      _1499: (x0,x1) => x0.test(x1),
      _1500: x0 => x0.pop(),
      _1502: o => o === undefined,
      _1504: o => typeof o === 'function' && o[jsWrappedDartFunctionSymbol] === true,
      _1506: o => {
        const proto = Object.getPrototypeOf(o);
        return proto === Object.prototype || proto === null;
      },
      _1507: o => o instanceof RegExp,
      _1508: (l, r) => l === r,
      _1509: o => o,
      _1510: o => o,
      _1511: o => o,
      ...
      _1513: o => o.length,
      _1515: (o, i) => o[i],
      _1516: f => f.dartFunction,
      _1517: () => ({}),
      _1518: () => [],
      _1520: () => globalThis,
      _1521: (constructor, args) => {
      ...
      _1523: (o, p) => o[p],
      _1524: (o, p, v) => o[p] = v,
      _1525: (o, m, a) => o[m].apply(o, a),
      _1527: o => String(o),
      _1528: (p, s, f) => p.then(s, (e) => f(e, e === undefined)),
      _1529: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1529(f,arguments.length,x0) }),
      _1530: f => finalizeWrapper(f, function(x0,x1) { return dartInstance.exports._1530(f,arguments.length,x0,x1) }),
      _1531: o => {
      ...
      _1532: o => [o],
      _1533: (o0, o1) => [o0, o1],
      _1534: (o0, o1, o2) => [o0, o1, o2],
      _1535: (o0, o1, o2, o3) => [o0, o1, o2, o3],
      ...
      _1550: x0 => x0.groups,
      _1551: x0 => x0.flags,
      _1552: x0 => x0.multiline,
      _1553: x0 => x0.ignoreCase,
      _1554: x0 => x0.unicode,
      _1555: x0 => x0.dotAll,
      _1556: (x0,x1) => { x0.lastIndex = x1 },
      _1557: (o, p) => p in o,
      _1558: (o, p) => o[p],
      _1569: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1569(f,arguments.length,x0) }),
      _1570: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1570(f,arguments.length,x0) }),
      _1575: (x0,x1) => new WebSocket(x0,x1),
      _1576: (x0,x1) => x0.send(x1),
      _1577: (x0,x1,x2) => x0.close(x1,x2),
      _1578: (x0,x1) => x0.close(x1),
      _1579: x0 => x0.close(),
      _1580: () => new AbortController(),
      _1581: x0 => x0.abort(),
      _1582: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _1583: (x0,x1) => globalThis.fetch(x0,x1),
      _1584: (x0,x1) => x0.get(x1),
      ...
      _3501: () => globalThis.window,
      _3544: x0 => x0.location,
      _3563: x0 => x0.navigator,
      _3827: x0 => x0.localStorage,
      _3835: x0 => x0.href,
      _3952: x0 => x0.userAgent,
      _4003: x0 => x0.data,
      _4050: (x0,x1) => { x0.onmessage = x1 },
      _4157: x0 => x0.length,
      _4374: x0 => x0.readyState,
      _4387: (x0,x1) => { x0.binaryType = x1 },
      _4390: x0 => x0.code,
      _4391: x0 => x0.reason,
      _6099: x0 => x0.signal,
      _7935: x0 => x0.value,
